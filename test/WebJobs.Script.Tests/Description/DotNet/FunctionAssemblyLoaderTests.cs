...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class FunctionAssemblyLoaderTests
    {
        ...
        public void ResolveAssembly_WithIndirectPrivateDependency_IsResolved()
        {
            ...
            resolver.CreateOrUpdateContext(metadata1, this.GetType().Assembly, new FunctionMetadataResolver(metadata1.ScriptFile, new Collection<ScriptBindingProvider>(), null), null);
            resolver.CreateOrUpdateContext(metadata2, this.GetType().Assembly, mockResolver.Object, null);
